...
def run_again(project, device, source_screen, fragment, node_weight):
    """
    :param project: 项目对象
    :param device: 设备对象
    :param screen: 场景对象
    ...
    while len(widget_stack) != 0:
        ...
        if screenvector not in project.screenlist:
            ...
            if screenvector not in node_weight:
                print("[-] Screen is old: ", screenvector)
                # os.remove(project.tmppng)
                continue
        ...
        if currentFra == "":
            currentFra = fragment
        try:
            run_again(project, device, new_screen, currentFra, node_weight)
        except:
            print("======================================")
            print("[-] Run Fault!")
            print("======================================")
